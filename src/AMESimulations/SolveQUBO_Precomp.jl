...
function SolveWithAME_dm_v2(annealing_problem, annealing_time, ss, ω_len)
    sol_ame = solve_ame(annealing_problem, annealing_time, alg=Vern6(), ω_hint=range(-40, 40, length = ω_len), abstol=1e-9, reltol=1e-9)
